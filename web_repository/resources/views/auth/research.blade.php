...
<body>
    ...
    <div class="content">
        ...
        @if($paginatedResearch->isEmpty())
            <p class="no-result">No Files found.</p>
        @else
            <ul class="file-list"> 
                @foreach($paginatedResearch as $result)
                    <li class="file-item research">
            ...
            <div class="pagination-container">
                <div class="pagination-top">
                    <div>
                        <p class="small text-muted">
                            {!! __('Showing') !!}
                            <span class="fw-semibold">{{ $paginatedResearch->firstItem() }}</span>
                            {!! __('to') !!}
                            <span class="fw-semibold">{{ $paginatedResearch->lastItem() }}</span>
                            {!! __('of') !!}
                            <span class="fw-semibold">{{ $paginatedResearch->total() }}</span>
                            {!! __('results') !!}
                        </p>
                    </div>
                </div>
                ...
                <div class="pagination-bottom">
                    {{ $paginatedResearch->links('pagination::bootstrap-5') }}
                </div>   
            </div>
        @endif
    </div>
