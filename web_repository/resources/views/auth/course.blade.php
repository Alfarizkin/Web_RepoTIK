...
<body>
    ...
    <div class="content">
        ...
        @if($paginatedCourse->isEmpty())
            <p class="no-result">No Files found.</p>
        @else
            <ul class="file-list"> 
                @foreach($paginatedCourse as $result)
                    <li class="file-item course">
            ...
            <div class="pagination-container">
                <div class="pagination-top">
                    <div>
                        <p class="small text-muted">
                            {!! __('Showing') !!}
                            <span class="fw-semibold">{{ $paginatedCourse->firstItem() }}</span>
                            {!! __('to') !!}
                            <span class="fw-semibold">{{ $paginatedCourse->lastItem() }}</span>
                            {!! __('of') !!}
                            <span class="fw-semibold">{{ $paginatedCourse->total() }}</span>
                            {!! __('results') !!}
                        </p>
                    </div>
                </div>
                ...
                <div class="pagination-bottom">
                    {{ $paginatedCourse->links('pagination::bootstrap-5') }}
                </div>   
            </div>
        @endif
    </div>
